const data = [
    {
      ...
      incorrectAnswers: [
        "Chris Smith Style",
        "50 Crazy Shades of Snore",
        "Classic Seafood/Shrimp Sushi"
      ],
  ...
  
    {
      ...
      incorrectAnswers: [
        "She likes CSS",
        "She likes Chris' smiley face and hug",
        "She likes Chris' accessories and weirdness",
      ],
      correctAnswer: "She likes Chris Smith",
    },
    {
    ...
    {
      question: "How much does Xiaxin like Chris Smith",
      incorrectAnswers: [
          "Nothing Steve Jobs ever created could fully replace Chris in Xiaxin's life (but she never can afford an airpro/airbook iphone ipad etc).", 
          "She likes Chris slightly more than she likes bacon, but definitely not as much as a pig loves not being bacon.", 
          "She likes Chris almost exactly as much as won't freak him out."
        ],
    ...
    {
      question: "What kind of things Xiaxin wants to do with Chris?",
      incorrectAnswers: [
        "She wants to watch talkshow with Chris every night",
        "She wants Chris and her to make fun of each other but never get tired of doing that",
        "She wants Chris and her to argue with each other and then give each other a bear hug",
      ],
      correctAnswer: "She wants to do all boring things with Chris",
    },
    {
